...
Godot 4 under `godot/` is the canonical Fake Kirdy runtime. Current implementation work should use checked-in Godot docs, data, resources, tests, replay fixtures, and validation scripts.
...
- Controller, doors, levels, combat, outcomes, saves, map/HUD/inventory/settings/pause/result/error UI, virtual controls, audio mix, generated content, and replay traces are documented from `mem:docs/index`.
...
- `npm run test:canonical` before claiming canonical gameplay behavior when Godot is available.
