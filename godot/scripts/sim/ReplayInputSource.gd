...
var initial_completed_level_ids: Array[String] = []
var initial_defeated_enemy_group_ids: Array[String] = []
var initial_defeated_boss_ids: Array[String] = []
...
func load_replay(path: String) -> bool:
    ...
    initial_completed_level_ids = parse_string_array(parsed.get("initial_completed_level_ids", []))
    initial_defeated_enemy_group_ids = parse_string_array(parsed.get("initial_defeated_enemy_group_ids", []))
    initial_defeated_boss_ids = parse_string_array(parsed.get("initial_defeated_boss_ids", []))
